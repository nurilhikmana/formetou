...
(function () {
  ...
  document.getElementById("loveLevelMeter").textContent =
    `Love Level: ${currentLevel}%`;
})();
...
const playlists = {
  soft: [
    {
      ...
      src: "cas.mp3",
      type: "bgm",
      img: "cas.jpg", // New Album Art Path
    },
    {
      title: "About You",
      src: "aboutyou.mp3",
  ...
  night: [
    ...
    },
    {
      ...
      src: "thestrokes.mp3",
      type: "player",
      img: "thestrokes.jpg", // New Album Art Path
    },
  ],
  happy: [
    {
      ...
      src: "firasat.mp3",
      type: "player",
      img: "firasat.jpg", // New Album Art Path
    },
    {
      title: "Mrs Magic",
      src: "mrsmagic.mp3",
...
// =========================================================
// 18. ART GALLERY LOGIC
// =========================================================
const sketches = [
  {
    src: "first.jpeg",
    title: "Lovely Lines",
    desc: "suka sama arsiran yg ini n first time sketc ur beauty",
  },
  {
    src: "flowers.jpeg",
    title: "Moonlight Muse",
    desc: "sebenernya belum beres cuma ga tahan pengen foto haha",
  },
  {
    src: "us.jpeg",
    title: "Dreamy Eyes",
  ...
  { src: "grid.jpeg", title: "Soft Soul", desc: "ur so fuckin beauty love." },
  // Tambahkan path foto sketsa lainnya di sini
];
...
function renderGallery() {
  ...
  sketches.forEach((art) => {
    const item = document.createElement("div");
    item.className = "gallery-item";
    item.innerHTML = `
      <img src="${art.src}" onerror="this.src='https://via.placeholder.com/300/e85f97/ffffff?text=Sketch'">
      <div class="art-info">${art.title}</div>
    `;

    item.addEventListener("click", () => {
      document.getElementById("lightboxImg").src = art.src;
      document.getElementById("lightboxCaption").textContent = art.desc;
      document.getElementById("galleryModal").style.display = "flex";
      increaseLove(2);
      saveAch("Admired her art");
    });
...
document.getElementById("openGallery")?.addEventListener("click", () => {
  document.getElementById("artGallery").scrollIntoView({ behavior: "smooth" });
  showToast("Looking at your masterpieces! 🎨");
});
